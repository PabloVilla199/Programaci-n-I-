...
/*
 * Habilita modo crudo: sin echo, sin enter y sin espera
 */
 ...
 */
void hacer_cursor_visible(bool habilitacion) {
#if defined linux || MAC
  if (habilitacion) {
...
/*
 *  Retarda ejecución en los milisegundos indicados
 */
void retardar(int ms) {
#if defined linux || MAC
  usleep(ms * 1000);
  fflush(stdout);
#elif defined _WIN32
