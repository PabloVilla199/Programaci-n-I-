...
*/
  ...
  const int MOVIMIENTO_Y_INICIAL = 0;
 ...
 int main() {
     ...
     int movimiento_x = MOVIMIENTO_X_INICIAL;
     int movimiento_y  = MOVIMIENTO_Y_INICIAL;
     char tecla = '\0';
  ...
  while (tecla != TECLA_FIN && serpiente_x != LIMITE_IZQUIERDA && serpiente_x != LIMITE_DERECHA &&
        ...
        switch (toupper(tecla)) {
            ...
            case IZQUIERDA:
                ...
                movimiento_y = MOVIMIENTO_Y_INICIAL;
            break;
